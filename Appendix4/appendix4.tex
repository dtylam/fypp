...
\begin{table}[!ht]
	...
	\begin{tabular}{|c|c|c|c|c|}
		...
		Participant & A                       & F                   & C                        & E \\
		\hline
		Scale Given & \cellcolor{Dandelion} 3 & \cellcolor{green} 5 & \cellcolor{SpringGreen}4 & ? \\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[!ht]
	...
	\begin{tabularx}{0.325\textwidth}{|c|c|c|c|c|}
		...
		Participant & A                      & F                  & C                  & E \\
		\hline
		Scale Given & \cellcolor{Dandelion}3 & \cellcolor{green}5 & \cellcolor{green}5 & ? \\
		\hline
	\end{tabularx}
\end{table}
...
\textit{Student C}: "Having the tick boxes makes it a lot easier because they can't go off what they've set out themselves."\\
...
\begin{table}[!ht]
	...
	\begin{tabularx}{0.325\textwidth}{|c|c|c|c|c|}
		...
		Participant & A                  & F                  & C                  & E \\
		\hline
		Scale Given & \cellcolor{green}5 & \cellcolor{green}5 & \cellcolor{green}5 & ? \\
		\hline
	\end{tabularx}
\end{table}
...
\begin{table}[!ht]
	...
	\begin{tabularx}{0.325\textwidth}{|c|c|c|c|c|}
		...
		Participant & A                  & F                  & C                  & E \\
		\hline
		Scale Given & \cellcolor{green}5 & \cellcolor{green}5 & \cellcolor{green}4 & ? \\
		\hline
	\end{tabularx}
\end{table}
...
\begin{table}[!ht]
	...
	\begin{tabularx}{0.325\textwidth}{|c|c|c|c|c|}
		...
		Participant & A                        & F                      & C                      & E \\
		\hline
		Scale Given & \cellcolor{SpringGreen}4 & \cellcolor{Dandelion}3 & \cellcolor{Dandelion}3 & ? \\
		\hline
	\end{tabularx}
\end{table}
...
\begin{table}[!ht]
	...
	\begin{tabularx}{0.325\textwidth}{|c|c|c|c|c|}
		...
		Participant & A                  & F                  & C                      & E \\
		\hline
		Scale Given & \cellcolor{green}5 & \cellcolor{green}5 & \cellcolor{Dandelion}3 & ? \\
		\hline
	\end{tabularx}
\end{table}
...
\begin{table}[!ht]
	...
	\begin{tabularx}{0.325\textwidth}{|c|c|c|c|c|}
		...
		Participant & A                        & F                  & C                  & E \\
		\hline
		Scale Given & \cellcolor{SpringGreen}4 & \cellcolor{green}5 & \cellcolor{green}5 & ? \\
		\hline
	\end{tabularx}
\end{table}
...
\begin{table}[!ht]
	...
	\begin{tabularx}{0.325\textwidth}{|c|c|c|c|c|}
		...
		Participant & A                        & F                  & C                        & E \\
		\hline
		Scale Given & \cellcolor{SpringGreen}4 & \cellcolor{green}5 & \cellcolor{SpringGreen}4 & ? \\
		\hline
	\end{tabularx}
\end{table}
