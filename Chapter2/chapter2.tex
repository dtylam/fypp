...
There are two types of blockchains: one being a public and permissionless blockchain, and the other 
a private and permissioned blockchain \citep[p.1]{wust2017you}. These two 
types of blockchain each provide varying degrees of the following properties:

\begin{itemize}
    \item Public Verifiability \\
    Permissionless blockchains provide a maximal degree of public verifiability, because every addition 
    to the blockchain is confirmed by verifiers/ miners, and any observers can verify the state of the 
    blockchain.\\
    Permissioned blockchains are more centralised with an amount of trust required for a central 
    authority that acts as an administrator for all peer servers. Additions to the blockchain is achieved 
    by an agreed consensus mechanism.
    \item Privacy\\
    Permissionless blockchains provide maximal verifiability and transparency, but could 
    \item Integrity
    \item Redundancy\\\citep[p.2]{wust2017you}
\end{itemize}
