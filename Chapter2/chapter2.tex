...
This will enable further transparency and accountability to the education provider level compared to the Sony 
Global Education or the OpenLearn projects, using smart contracts to protect learners and ensure that they receive 
their rewards automatically.

This vision of this project will also be to create an e-Learning marketplace that teachers can use directly, 
instead of a blockchain network that education providers will have to consume through APIs. 
