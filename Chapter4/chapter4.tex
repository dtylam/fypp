...
Table \ref{table:fx-reqs} lists out the functional requirements (FR) and 
table \ref{table:nonfx-reqs} the non-functional requirements (NR) adopted by this 
...
\begin{table}[!h] 
    ...
    \begin{tabularx}{\textwidth}{>{\bfseries}l>{\hsize=1.6\hsize}X>{\hsize=.4\hsize}Xl}
        ...
        a responsive interface & PS15 & Should Have\\\midrule
        ...
        NR4 & The system should be able to reduce administrative work & PS12 & Should Have\\\midrule
        NR5 & The system should be able to create more trust in online education providers 
        and programmes & PS19 & Should Have\\\midrule
        \bottomrule
    \end{tabularx}
\end{table}