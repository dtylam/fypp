...
It was clear that a blockchain specific, high-fidelity prototyping tool is needed
...
\begin{itemize}
	...
	\item \underline{Administrative Work for Personalisation}: Primary data suggested that administrative and regulatory work required for
	      ...
	      the suggested regulatory steps for the UK market (see PS9 in Chapter 4.1.2). Making these administrative data available on the blockchain
