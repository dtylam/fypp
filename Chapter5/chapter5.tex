...
\begin{itemize}
    ...
    \item \underline{Reducing administration}: programme outcomes: middleman fields bureaucracy
    \item \underline{Content flexibility}: Markdown is [TODO]. It is anticipated that many markets, institutions, departments and teachers 
