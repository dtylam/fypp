...
\begin{figure}[!ht]
	...
	\caption{Flowchart representation of the Smart Contract for the CreateModule Transaction (Tx)} \label{fig:cmtx}
\end{figure}
...
\begin{figure}[!ht]
	...
	\caption{Flowchart representation of the Smart Contract for the AddSubmission Transaction (Tx)} \label{fig:astx}
\end{figure}
...
\begin{figure}[!ht]
	...
	\caption{Flowchart representation of the Smart Contract for the SubmitResult Transaction (Tx)} \label{fig:srtx}
\end{figure}
...
\begin{figure}[!ht]
	...
	\caption{Flowchart representation of the Smart Contract for the GenCertificate Transaction (Tx)} \label{fig:gctx}
\end{figure}
...
\begin{figure}[!ht]
	...
	\caption{Flowchart representation of the Smart Contract for the ProposeCurriculum Transaction (Tx)} \label{fig:pctx}
\end{figure}
...
\begin{figure}[!ht]
	...
	\caption{Flowchart representation of the Smart Contract for the ApproveCurriculum Transaction (Tx)} \label{fig:actx}
\end{figure}
...
\begin{table}[!ht]
	\caption{The usability considerations for client applications}
	\centering
...
\begin{figure}[!ht]
	...
	\caption{Sitemap designs for the learner and teacher client applications with notes on the location of transaction ordering dialogues.} \label{fig:sitemaps}
\end{figure}
